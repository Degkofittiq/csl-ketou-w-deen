                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Détails de la Bio du Fondateur</h6>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                                <label for="name">Nom</label>
                                <input class="form-control my-2" type="text" name="name" id="name" value="<?php htmlspecialchars($aboutUs['name']); ?>" readonly>
                            </div>
                            <div class="form-group">
