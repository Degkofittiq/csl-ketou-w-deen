                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Détails de l'espace</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control my-2" type="text" name="amount" id="amount" value="<?php echo htmlspecialchars($aboutUs['amount']); ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="image">Image actuelle</label><br>
                                <img src="../../../image/<?php echo htmlspecialchars($aboutUs['images']); ?>" alt="Image" width="150"><br>
                            </div>
