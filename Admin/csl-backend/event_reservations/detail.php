                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Détails de la reservation pour evenement</h6>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                                <label for="name">Nom</label>
                                <input class="form-control my-2" type="text" name="client_name" id="client_name" value="<?php echo htmlspecialchars($aboutUs['client_name']); ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label for="client_num">Numero client</label>
                                <textarea class="form-control my-2" name="client_num" id="client_num" readonly><?php echo htmlspecialchars($aboutUs['client_num']); ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="event_name">Nom de l'evenement</label>
                                <textarea class="form-control my-2" name="event_name" id="event_name" readonly><?php echo htmlspecialchars($aboutUs['event_name']); ?></textarea>
                            </div>
