...
if (isset($_GET['id'])) {
    ...
    $stmt = $pdo->prepare("SELECT * FROM contact_email WHERE id = ?");
    $stmt->execute([$id]);
    $aboutUs = $stmt->fetch();
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control my-2" name="email" id="email" readonly><?php echo htmlspecialchars($aboutUs['email']); ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="phone">phone</label>
                                <textarea class="form-control my-2" name="phone" id="phone" readonly><?php echo htmlspecialchars($aboutUs['phone']); ?></textarea>
                            </div>
